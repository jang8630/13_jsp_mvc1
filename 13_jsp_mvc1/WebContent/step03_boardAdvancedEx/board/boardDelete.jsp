...
<body>
	...
	<div align="center">
		...
		<input type="button" value="삭제하기" onclick="location.href='boardDeletePro.jsp?boardId=<%=boardId%>'">
		<input type="button" value="취소" onclick="location.href='boardDetail.jsp?boardId=<%=boardId%>'">
	</div>
